                            ...
                            <tbody>
                                {bugReports.map((b, i) => (
                                    <tr key={b.id} style={{animationDelay: `${i * 0.05}s`}}>
                                        ...
                                        <td>
                                            {b.screenshotUrl ? (
                                                <a href={`${process.env.NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_SOCKET_URL || 'http://localhost:3000'}${b.screenshotUrl}`} target="_blank" rel="noopener noreferrer" className="screenshot-link">
                                                    View Image ↗
                                                </a>
                                            ) : (
